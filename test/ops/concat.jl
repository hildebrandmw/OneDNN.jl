@testset "Testing Concat" begin
    ...
    function tester(f, fargs, g, gargs; fkw...)
        ...
        Δ = Float32(0.125) * randn(Float32, size(expected))
        ...
        @test grads_result[2][1] == grads_expected[2]
        @test grads_result[2][2] == grads_expected[3]
        @test grads_result[2][3] == grads_expected[4]
