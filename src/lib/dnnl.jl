...
function dnnl_primitive_desc_iterator_create(
    ...
    return ccall(
        (:dnnl_primitive_desc_iterator_create, dnnl),
        dnnl_status_t,
        (
...
function dnnl_primitive_desc_iterator_next(iterator)
    return ccall(
        (:dnnl_primitive_desc_iterator_next, dnnl),
        dnnl_status_t,
...
function dnnl_primitive_desc_iterator_fetch(iterator)
    return ccall(
        (:dnnl_primitive_desc_iterator_fetch, dnnl),
...
function dnnl_primitive_desc_iterator_destroy(iterator)
    return ccall(
        (:dnnl_primitive_desc_iterator_destroy, dnnl),
        dnnl_status_t,
        (dnnl_primitive_desc_iterator_t,),
        iterator,
    )
...
function dnnl_primitive_desc_create(
    ...
    return ccall(
        (:dnnl_primitive_desc_create, dnnl),
        dnnl_status_t,
        (
...
function dnnl_primitive_desc_clone(primitive_desc, existing_primitive_desc)
    return ccall(
        (:dnnl_primitive_desc_clone, dnnl),
        dnnl_status_t,
...
function dnnl_primitive_desc_get_attr(primitive_desc, attr)
    return ccall(
        (:dnnl_primitive_desc_get_attr, dnnl),
        dnnl_status_t,
...
function dnnl_primitive_desc_destroy(primitive_desc)
    return ccall(
        (:dnnl_primitive_desc_destroy, dnnl),
        dnnl_status_t,
        (dnnl_primitive_desc_t,),
        primitive_desc,
    )
...
function dnnl_primitive_desc_query(primitive_desc, what, index, result)
    return ccall(
        (:dnnl_primitive_desc_query, dnnl),
        dnnl_status_t,
...
function dnnl_primitive_desc_query_md(primitive_desc, what, index)
    return ccall(
        (:dnnl_primitive_desc_query_md, dnnl),
...
function dnnl_primitive_desc_query_s32(primitive_desc, what, index)
    return ccall(
        (:dnnl_primitive_desc_query_s32, dnnl),
        Cint,
        (const_dnnl_primitive_desc_t, dnnl_query_t, Cint),
        primitive_desc,
        what,
...
function dnnl_primitive_get_primitive_desc(primitive, primitive_desc)
    return ccall(
        (:dnnl_primitive_get_primitive_desc, dnnl),
        dnnl_status_t,
...
function dnnl_primitive_destroy(primitive)
    return ccall(
        (:dnnl_primitive_destroy, dnnl), dnnl_status_t, (dnnl_primitive_t,), primitive
    )
end

function dnnl_primitive_attr_create(attr)
    return ccall(
        (:dnnl_primitive_attr_create, dnnl),
        dnnl_status_t,
...
function dnnl_primitive_attr_clone(attr, existing_attr)
    return ccall(
        (:dnnl_primitive_attr_clone, dnnl),
        dnnl_status_t,
...
function dnnl_primitive_attr_destroy(attr)
    return ccall(
        (:dnnl_primitive_attr_destroy, dnnl), dnnl_status_t, (dnnl_primitive_attr_t,), attr
    )
end

function dnnl_primitive_attr_get_scratchpad_mode(attr, mode)
    return ccall(
        (:dnnl_primitive_attr_get_scratchpad_mode, dnnl),
        dnnl_status_t,
...
function dnnl_primitive_attr_set_scratchpad_mode(attr, mode)
    return ccall(
        (:dnnl_primitive_attr_set_scratchpad_mode, dnnl),
        dnnl_status_t,
...
function dnnl_primitive_attr_get_output_scales(attr, count, mask, scales)
    return ccall(
        (:dnnl_primitive_attr_get_output_scales, dnnl),
        dnnl_status_t,
...
function dnnl_primitive_attr_set_output_scales(attr, count, mask, scales)
    return ccall(
        (:dnnl_primitive_attr_set_output_scales, dnnl),
        dnnl_status_t,
...
function dnnl_primitive_attr_get_scales(attr, arg, count, mask, scales)
    return ccall(
        (:dnnl_primitive_attr_get_scales, dnnl),
        dnnl_status_t,
...
function dnnl_primitive_attr_set_scales(attr, arg, count, mask, scales)
    return ccall(
        (:dnnl_primitive_attr_set_scales, dnnl),
        dnnl_status_t,
...
function dnnl_primitive_attr_get_zero_points(attr, arg, count, mask, zero_points)
    return ccall(
        (:dnnl_primitive_attr_get_zero_points, dnnl),
        dnnl_status_t,
...
function dnnl_primitive_attr_set_zero_points(attr, arg, count, mask, zero_points)
    return ccall(
        (:dnnl_primitive_attr_set_zero_points, dnnl),
        dnnl_status_t,
...
function dnnl_primitive_attr_get_post_ops(attr, post_ops)
    return ccall(
        (:dnnl_primitive_attr_get_post_ops, dnnl),
        dnnl_status_t,
...
function dnnl_primitive_attr_set_post_ops(attr, post_ops)
    return ccall(
        (:dnnl_primitive_attr_set_post_ops, dnnl),
        dnnl_status_t,
...
function dnnl_post_ops_create(post_ops)
    return ccall(
        (:dnnl_post_ops_create, dnnl), dnnl_status_t, (Ptr{dnnl_post_ops_t},), post_ops
    )
end

function dnnl_post_ops_destroy(post_ops)
    return ccall(
        (:dnnl_post_ops_destroy, dnnl), dnnl_status_t, (dnnl_post_ops_t,), post_ops
    )
end

function dnnl_post_ops_len(post_ops)
    return ccall((:dnnl_post_ops_len, dnnl), Cint, (const_dnnl_post_ops_t,), post_ops)
end

function dnnl_post_ops_get_kind(post_ops, index)
    return ccall(
        (:dnnl_post_ops_get_kind, dnnl),
...
function dnnl_post_ops_append_sum_v2(post_ops, scale, data_type)
    return ccall(
        (:dnnl_post_ops_append_sum_v2, dnnl),
        dnnl_status_t,
...
function dnnl_post_ops_get_params_sum(post_ops, index, scale)
    return ccall(
        (:dnnl_post_ops_get_params_sum, dnnl),
        dnnl_status_t,
...
function dnnl_post_ops_get_params_sum_v2(post_ops, index, scale, data_type)
    return ccall(
        (:dnnl_post_ops_get_params_sum_v2, dnnl),
        dnnl_status_t,
...
function dnnl_post_ops_append_eltwise(post_ops, scale, alg_kind, alpha, beta)
    return ccall(
        (:dnnl_post_ops_append_eltwise, dnnl),
        dnnl_status_t,
...
function dnnl_post_ops_get_params_eltwise(post_ops, index, scale, alg_kind, alpha, beta)
    return ccall(
        (:dnnl_post_ops_get_params_eltwise, dnnl),
        dnnl_status_t,
        (
...
function dnnl_post_ops_append_dw_k3s1p1(
    ...
    return ccall(
        (:dnnl_post_ops_append_dw_k3s1p1, dnnl),
        dnnl_status_t,
        (
            dnnl_post_ops_t,
            dnnl_data_type_t,
...
function dnnl_post_ops_get_params_dw_k3s1p1(
    ...
    return ccall(
        (:dnnl_post_ops_get_params_dw_k3s1p1, dnnl),
        dnnl_status_t,
        (
            const_dnnl_post_ops_t,
            Cint,
...
function dnnl_post_ops_append_dw_k3s2p1(
    ...
    return ccall(
        (:dnnl_post_ops_append_dw_k3s2p1, dnnl),
        dnnl_status_t,
        (
            dnnl_post_ops_t,
            dnnl_data_type_t,
...
function dnnl_post_ops_get_params_dw_k3s2p1(
    ...
    return ccall(
        (:dnnl_post_ops_get_params_dw_k3s2p1, dnnl),
        dnnl_status_t,
        (
            const_dnnl_post_ops_t,
            Cint,
...
function dnnl_post_ops_append_binary(post_ops, alg_kind, src1_desc)
    return ccall(
        (:dnnl_post_ops_append_binary, dnnl),
        dnnl_status_t,
...
function dnnl_post_ops_get_params_binary(post_ops, index, alg_kind, src1_desc)
    return ccall(
        (:dnnl_post_ops_get_params_binary, dnnl),
        dnnl_status_t,
...
function dnnl_memory_desc_init_by_strides(memory_desc, ndims, dims, data_type, strides)
    return ccall(
        (:dnnl_memory_desc_init_by_strides, dnnl),
        dnnl_status_t,
        (Ptr{dnnl_memory_desc_t}, Cint, Ptr{dnnl_dim_t}, dnnl_data_type_t, Ptr{dnnl_dim_t}),
        memory_desc,
        ndims,
        dims,
        data_type,
...
function dnnl_memory_desc_init_by_tag(memory_desc, ndims, dims, data_type, tag)
    return ccall(
        (:dnnl_memory_desc_init_by_tag, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_memory_desc_t},
            Cint,
...
function dnnl_memory_desc_init_submemory(memory_desc, parent_memory_desc, dims, offsets)
    return ccall(
        (:dnnl_memory_desc_init_submemory, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_memory_desc_t},
            Ptr{dnnl_memory_desc_t},
...
function dnnl_memory_desc_reshape(out_memory_desc, in_memory_desc, ndims, dims)
    return ccall(
        (:dnnl_memory_desc_reshape, dnnl),
        dnnl_status_t,
        (Ptr{dnnl_memory_desc_t}, Ptr{dnnl_memory_desc_t}, Cint, Ptr{dnnl_dim_t}),
        out_memory_desc,
        in_memory_desc,
        ndims,
        dims,
...
function dnnl_memory_desc_permute_axes(out_memory_desc, in_memory_desc, permutation)
    return ccall(
        (:dnnl_memory_desc_permute_axes, dnnl),
        dnnl_status_t,
...
function dnnl_memory_desc_get_size(memory_desc)
    return ccall(
        (:dnnl_memory_desc_get_size, dnnl), Csize_t, (Ptr{dnnl_memory_desc_t},), memory_desc
    )
end

function dnnl_memory_create(memory, memory_desc, engine, handle)
    return ccall(
        (:dnnl_memory_create, dnnl),
        dnnl_status_t,
...
function dnnl_memory_get_memory_desc(memory, memory_desc)
    return ccall(
        (:dnnl_memory_get_memory_desc, dnnl),
        dnnl_status_t,
...
function dnnl_memory_get_data_handle(memory, handle)
    return ccall(
        (:dnnl_memory_get_data_handle, dnnl),
        dnnl_status_t,
        (const_dnnl_memory_t, Ptr{Ptr{Cvoid}}),
        memory,
        handle,
...
function dnnl_memory_set_data_handle(memory, handle)
    return ccall(
        (:dnnl_memory_set_data_handle, dnnl),
        dnnl_status_t,
...
function dnnl_memory_set_data_handle_v2(memory, handle, stream)
    return ccall(
        (:dnnl_memory_set_data_handle_v2, dnnl),
        dnnl_status_t,
...
function dnnl_memory_destroy(memory)
    return ccall((:dnnl_memory_destroy, dnnl), dnnl_status_t, (dnnl_memory_t,), memory)
end
...
function dnnl_reorder_primitive_desc_create(
    ...
    return ccall(
        (:dnnl_reorder_primitive_desc_create, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_primitive_desc_t},
            Ptr{dnnl_memory_desc_t},
...
function dnnl_concat_primitive_desc_create(
    ...
    return ccall(
        (:dnnl_concat_primitive_desc_create, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_primitive_desc_t},
            Ptr{dnnl_memory_desc_t},
...
function dnnl_sum_primitive_desc_create(
    ...
    return ccall(
        (:dnnl_sum_primitive_desc_create, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_primitive_desc_t},
            Ptr{dnnl_memory_desc_t},
...
function dnnl_convolution_forward_desc_init(
    ...
    return ccall(
        (:dnnl_convolution_forward_desc_init, dnnl),
        dnnl_status_t,
        (
...
function dnnl_dilated_convolution_forward_desc_init(
    ...
    return ccall(
        (:dnnl_dilated_convolution_forward_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_convolution_desc_t},
            dnnl_prop_kind_t,
...
function dnnl_convolution_backward_data_desc_init(
    ...
    return ccall(
        (:dnnl_convolution_backward_data_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_convolution_desc_t},
            dnnl_alg_kind_t,
...
function dnnl_dilated_convolution_backward_data_desc_init(
    ...
    return ccall(
        (:dnnl_dilated_convolution_backward_data_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_convolution_desc_t},
            dnnl_alg_kind_t,
...
function dnnl_convolution_backward_weights_desc_init(
    ...
    return ccall(
        (:dnnl_convolution_backward_weights_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_convolution_desc_t},
            dnnl_alg_kind_t,
...
function dnnl_dilated_convolution_backward_weights_desc_init(
    ...
    return ccall(
        (:dnnl_dilated_convolution_backward_weights_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_convolution_desc_t},
            dnnl_alg_kind_t,
...
function dnnl_deconvolution_forward_desc_init(
    ...
    return ccall(
        (:dnnl_deconvolution_forward_desc_init, dnnl),
        dnnl_status_t,
        (
...
function dnnl_dilated_deconvolution_forward_desc_init(
    ...
    return ccall(
        (:dnnl_dilated_deconvolution_forward_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_deconvolution_desc_t},
            dnnl_prop_kind_t,
...
function dnnl_deconvolution_backward_data_desc_init(
    ...
    return ccall(
        (:dnnl_deconvolution_backward_data_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_deconvolution_desc_t},
            dnnl_alg_kind_t,
...
function dnnl_dilated_deconvolution_backward_data_desc_init(
    ...
    return ccall(
        (:dnnl_dilated_deconvolution_backward_data_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_deconvolution_desc_t},
            dnnl_alg_kind_t,
...
function dnnl_deconvolution_backward_weights_desc_init(
    ...
    return ccall(
        (:dnnl_deconvolution_backward_weights_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_deconvolution_desc_t},
            dnnl_alg_kind_t,
...
function dnnl_dilated_deconvolution_backward_weights_desc_init(
    ...
    return ccall(
        (:dnnl_dilated_deconvolution_backward_weights_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_deconvolution_desc_t},
            dnnl_alg_kind_t,
...
function dnnl_shuffle_forward_desc_init(
    ...
    return ccall(
        (:dnnl_shuffle_forward_desc_init, dnnl),
        dnnl_status_t,
        (
...
function dnnl_shuffle_backward_desc_init(shuffle_desc, diff_data_desc, axis, group_size)
    return ccall(
        (:dnnl_shuffle_backward_desc_init, dnnl),
        dnnl_status_t,
...
function dnnl_eltwise_forward_desc_init(
    ...
    return ccall(
        (:dnnl_eltwise_forward_desc_init, dnnl),
        dnnl_status_t,
        (
...
function dnnl_eltwise_backward_desc_init(
    ...
    return ccall(
        (:dnnl_eltwise_backward_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_eltwise_desc_t},
            dnnl_alg_kind_t,
...
function dnnl_softmax_forward_desc_init(softmax_desc, prop_kind, data_desc, softmax_axis)
    return ccall(
        (:dnnl_softmax_forward_desc_init, dnnl),
        dnnl_status_t,
...
function dnnl_softmax_backward_desc_init(
    ...
    return ccall(
        (:dnnl_softmax_backward_desc_init, dnnl),
        dnnl_status_t,
...
function dnnl_logsoftmax_forward_desc_init(
    ...
    return ccall(
        (:dnnl_logsoftmax_forward_desc_init, dnnl),
        dnnl_status_t,
...
function dnnl_logsoftmax_backward_desc_init(
    ...
    return ccall(
        (:dnnl_logsoftmax_backward_desc_init, dnnl),
        dnnl_status_t,
        (
...
function dnnl_pooling_forward_desc_init(
    ...
    return ccall(
        (:dnnl_pooling_forward_desc_init, dnnl),
        dnnl_status_t,
        (
...
function dnnl_pooling_backward_desc_init(
    ...
    return ccall(
        (:dnnl_pooling_backward_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_pooling_desc_t},
            dnnl_alg_kind_t,
...
function dnnl_pooling_v2_forward_desc_init(
    ...
    return ccall(
        (:dnnl_pooling_v2_forward_desc_init, dnnl),
        dnnl_status_t,
        (
...
function dnnl_pooling_v2_backward_desc_init(
    ...
    return ccall(
        (:dnnl_pooling_v2_backward_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_pooling_v2_desc_t},
            dnnl_alg_kind_t,
...
function dnnl_prelu_forward_desc_init(prelu_desc, prop_kind, data_desc, weights_desc)
    return ccall(
        (:dnnl_prelu_forward_desc_init, dnnl),
        dnnl_status_t,
        (
...
function dnnl_prelu_backward_desc_init(
    ...
    return ccall(
        (:dnnl_prelu_backward_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_prelu_desc_t},
            Ptr{dnnl_memory_desc_t},
...
function dnnl_lrn_forward_desc_init(
    ...
    return ccall(
        (:dnnl_lrn_forward_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_lrn_desc_t},
            dnnl_prop_kind_t,
...
function dnnl_lrn_backward_desc_init(
    ...
    return ccall(
        (:dnnl_lrn_backward_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_lrn_desc_t},
            dnnl_alg_kind_t,
...
function dnnl_batch_normalization_forward_desc_init(
    ...
    return ccall(
        (:dnnl_batch_normalization_forward_desc_init, dnnl),
        dnnl_status_t,
        (
...
function dnnl_batch_normalization_backward_desc_init(
    ...
    return ccall(
        (:dnnl_batch_normalization_backward_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_batch_normalization_desc_t},
            dnnl_prop_kind_t,
...
function dnnl_layer_normalization_forward_desc_init(
    ...
    return ccall(
        (:dnnl_layer_normalization_forward_desc_init, dnnl),
        dnnl_status_t,
        (
...
function dnnl_layer_normalization_backward_desc_init(
    ...
    return ccall(
        (:dnnl_layer_normalization_backward_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_layer_normalization_desc_t},
            dnnl_prop_kind_t,
...
function dnnl_inner_product_forward_desc_init(
    ...
    return ccall(
        (:dnnl_inner_product_forward_desc_init, dnnl),
        dnnl_status_t,
        (
...
function dnnl_inner_product_backward_data_desc_init(
    ...
    return ccall(
        (:dnnl_inner_product_backward_data_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_inner_product_desc_t},
            Ptr{dnnl_memory_desc_t},
...
function dnnl_inner_product_backward_weights_desc_init(
    ...
    return ccall(
        (:dnnl_inner_product_backward_weights_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_inner_product_desc_t},
            Ptr{dnnl_memory_desc_t},
...
function dnnl_primitive_attr_set_rnn_data_qparams(attr, scale, shift)
    return ccall(
        (:dnnl_primitive_attr_set_rnn_data_qparams, dnnl),
        dnnl_status_t,
...
function dnnl_primitive_attr_get_rnn_data_qparams(attr, scale, shift)
    return ccall(
        (:dnnl_primitive_attr_get_rnn_data_qparams, dnnl),
        dnnl_status_t,
...
function dnnl_primitive_attr_set_rnn_weights_qparams(attr, count, mask, scales)
    return ccall(
        (:dnnl_primitive_attr_set_rnn_weights_qparams, dnnl),
        dnnl_status_t,
        (dnnl_primitive_attr_t, dnnl_dim_t, Cint, Ptr{Cfloat}),
        attr,
        count,
...
function dnnl_primitive_attr_get_rnn_weights_qparams(attr, count, mask, scales)
    return ccall(
        (:dnnl_primitive_attr_get_rnn_weights_qparams, dnnl),
        dnnl_status_t,
        (const_dnnl_primitive_attr_t, Ptr{dnnl_dim_t}, Ptr{Cint}, Ptr{Ptr{Cfloat}}),
        attr,
        count,
...
function dnnl_primitive_attr_set_rnn_weights_projection_qparams(attr, count, mask, scales)
    return ccall(
        (:dnnl_primitive_attr_set_rnn_weights_projection_qparams, dnnl),
        dnnl_status_t,
        (dnnl_primitive_attr_t, dnnl_dim_t, Cint, Ptr{Cfloat}),
        attr,
        count,
...
function dnnl_primitive_attr_get_rnn_weights_projection_qparams(attr, count, mask, scales)
    return ccall(
        (:dnnl_primitive_attr_get_rnn_weights_projection_qparams, dnnl),
        dnnl_status_t,
        (const_dnnl_primitive_attr_t, Ptr{dnnl_dim_t}, Ptr{Cint}, Ptr{Ptr{Cfloat}}),
        attr,
        count,
...
function dnnl_vanilla_rnn_forward_desc_init(
    ...
    return ccall(
        (:dnnl_vanilla_rnn_forward_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_rnn_desc_t},
            dnnl_prop_kind_t,
...
function dnnl_vanilla_rnn_backward_desc_init(
    ...
    return ccall(
        (:dnnl_vanilla_rnn_backward_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_rnn_desc_t},
            dnnl_prop_kind_t,
...
function dnnl_lstm_forward_desc_init(
    ...
    return ccall(
        (:dnnl_lstm_forward_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_rnn_desc_t},
            dnnl_prop_kind_t,
...
function dnnl_lstm_forward_desc_init_v2(
    ...
    return ccall(
        (:dnnl_lstm_forward_desc_init_v2, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_rnn_desc_t},
            dnnl_prop_kind_t,
...
function dnnl_lstm_forward_desc_init_v3(
    ...
    return ccall(
        (:dnnl_lstm_forward_desc_init_v3, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_rnn_desc_t},
            dnnl_prop_kind_t,
...
function dnnl_lstm_backward_desc_init(
    ...
    return ccall(
        (:dnnl_lstm_backward_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_rnn_desc_t},
            dnnl_prop_kind_t,
...
function dnnl_lstm_backward_desc_init_v2(
    ...
    return ccall(
        (:dnnl_lstm_backward_desc_init_v2, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_rnn_desc_t},
            dnnl_prop_kind_t,
...
function dnnl_lstm_backward_desc_init_v3(
    ...
    return ccall(
        (:dnnl_lstm_backward_desc_init_v3, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_rnn_desc_t},
            dnnl_prop_kind_t,
...
function dnnl_gru_forward_desc_init(
    ...
    return ccall(
        (:dnnl_gru_forward_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_rnn_desc_t},
            dnnl_prop_kind_t,
...
function dnnl_gru_backward_desc_init(
    ...
    return ccall(
        (:dnnl_gru_backward_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_rnn_desc_t},
            dnnl_prop_kind_t,
...
function dnnl_lbr_gru_forward_desc_init(
    ...
    return ccall(
        (:dnnl_lbr_gru_forward_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_rnn_desc_t},
            dnnl_prop_kind_t,
...
function dnnl_lbr_gru_backward_desc_init(
    ...
    return ccall(
        (:dnnl_lbr_gru_backward_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_rnn_desc_t},
            dnnl_prop_kind_t,
...
function dnnl_resampling_forward_desc_init(
    ...
    return ccall(
        (:dnnl_resampling_forward_desc_init, dnnl),
        dnnl_status_t,
        (
...
function dnnl_resampling_backward_desc_init(
    ...
    return ccall(
        (:dnnl_resampling_backward_desc_init, dnnl),
        dnnl_status_t,
        (
            Ptr{dnnl_resampling_desc_t},
            dnnl_alg_kind_t,
...
function dnnl_engine_get_count()
    return ccall((:dnnl_engine_get_count, dnnl), Cint, ())
end

function dnnl_engine_create(engine, kind, index)
    return ccall(
        (:dnnl_engine_create, dnnl),
        dnnl_status_t,
        (Ptr{dnnl_engine_t}, dnnl_engine_kind_t, Cint),
        engine,
        kind,
        index,
    )
...
function dnnl_engine_destroy(engine)
    return ccall((:dnnl_engine_destroy, dnnl), dnnl_status_t, (dnnl_engine_t,), engine)
end

function dnnl_stream_create(stream, engine, flags)
    return ccall(
        (:dnnl_stream_create, dnnl),
        dnnl_status_t,
        (Ptr{dnnl_stream_t}, dnnl_engine_t, UInt32),
        stream,
        engine,
        flags,
    )
...
function dnnl_stream_wait(stream)
    return ccall((:dnnl_stream_wait, dnnl), dnnl_status_t, (dnnl_stream_t,), stream)
end

function dnnl_stream_destroy(stream)
    return ccall((:dnnl_stream_destroy, dnnl), dnnl_status_t, (dnnl_stream_t,), stream)
end

function dnnl_get_primitive_cache_capacity(capacity)
    return ccall(
        (:dnnl_get_primitive_cache_capacity, dnnl), dnnl_status_t, (Ptr{Cint},), capacity
    )
end

function dnnl_set_primitive_cache_capacity(capacity)
    return ccall(
        (:dnnl_set_primitive_cache_capacity, dnnl), dnnl_status_t, (Cint,), capacity
    )
end

function dnnl_set_verbose(level)
    return ccall((:dnnl_set_verbose, dnnl), dnnl_status_t, (Cint,), level)
end

function dnnl_set_jit_dump(enable)
    return ccall((:dnnl_set_jit_dump, dnnl), dnnl_status_t, (Cint,), enable)
end

function dnnl_version()
    return ccall((:dnnl_version, dnnl), Ptr{dnnl_version_t}, ())
end

function dnnl_set_jit_profiling_flags(flags)
    return ccall((:dnnl_set_jit_profiling_flags, dnnl), dnnl_status_t, (UInt32,), flags)
end

function dnnl_set_jit_profiling_jitdumpdir(dir)
    return ccall((:dnnl_set_jit_profiling_jitdumpdir, dnnl), dnnl_status_t, (Cstring,), dir)
end

function dnnl_set_max_cpu_isa(isa)
    return ccall((:dnnl_set_max_cpu_isa, dnnl), dnnl_status_t, (dnnl_cpu_isa_t,), isa)
end

function dnnl_get_effective_cpu_isa()
    return ccall((:dnnl_get_effective_cpu_isa, dnnl), dnnl_cpu_isa_t, ())
end

function dnnl_set_cpu_isa_hints(isa_hints)
    return ccall(
        (:dnnl_set_cpu_isa_hints, dnnl), dnnl_status_t, (dnnl_cpu_isa_hints_t,), isa_hints
    )
end

function dnnl_get_cpu_isa_hints()
    return ccall((:dnnl_get_cpu_isa_hints, dnnl), dnnl_cpu_isa_hints_t, ())
end
